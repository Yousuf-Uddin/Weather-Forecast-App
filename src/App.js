    ...
    <div className="container py-5 h-100 text-white">
      <div className="row d-flex justify-content-center align-items-center h-100">
        <div className="col-md-8 col-lg-6 col-xl-4">
          ...
          <h3 className="mb-4 pb-1 fw-normal text-dark">Check the weather forecast</h3>

          <form onSubmit={getData}>
            <div className="CityInput d-flex rounded mb-5">
              <input type="search" required value={wcity} onChange={(e) => setWcity(e.target.value)} className="form-control rounded" placeholder="City" />
              <Button type='submit' className='mx-1 btn'>Submit</Button>
            </div>
          </form>

          <div className="Wcard mx-3">
            <div className={isloading ? "Loadgif" : "Hidegif"}>
